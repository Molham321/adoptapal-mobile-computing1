...
interface Api {
    ...
    /**
     * Address to LatLong conversion api
     */
    @GET("forward?access_key=${POSITIONSTACK_API_KEY}&limit=1")
    @Headers("Accept: application/json")
    suspend fun getLatLong(@Query("query") stringAddress: String): PositionsStackLatLongLookupResponse
}